...
if ( ($handle1 = fopen($base_path."get_all_grants_per_gene_per_year_from_csv_files_removing_overcounts_gt2.csv", "w") ) !== FALSE) {

 
     if ( ($handle2 = fopen($base_path."get_all_grants_per_gene_per_year_from_csv_files_analyze.csv", "r") ) !== FALSE) {
